...
class OrderTakingAgent(object):
    ...
    def get_response(self, messages):
        ...
        output = self.postprocess_response(chatbot_response, asked_recommendation_before, messages)
        
        return output
    
    def postprocess_response(self, response, asked_recommendation_before, messages):
